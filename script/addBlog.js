...
for (let i = 0; i < blogs.length; i++) {
	if (i % 2 === 0) {
      ...
      <div class="row p-4 align-items-center">
        ...
        <div class="blog-info col-md-6 d-flex flex-column justify-content-center mb-3">
          <h1>${blogs[i].title}</h1>
		...
		content += `
      <div class="row p-4 align-items-center">
        <div class="blog-info col-md-6 d-flex flex-column justify-content-center order-md-1 order-2">
          <h1>${blogs[i].title}</h1>
          <p style="font-size: 12px;">
            ${blogs[i].sub_title} <br />
            ${blogs[i].description}
        ...
        <div class="blog-img col-md-6 order-md-2 order-1">
          <img class="img-fluid" src="${blogs[i].img}" alt="background" />
        </div>
      </div>`;
	}
